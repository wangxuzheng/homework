...
# 定义训练集个测试集
train_data = datasets.CIFAR10(root=path, train=True, transform=transforms.ToTensor(), download=True)
test_data = datasets.CIFAR10(root=path, train=True, transform=transforms.ToTensor(), download=True)
